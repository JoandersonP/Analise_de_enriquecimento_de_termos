...
funcao_molecular_ESEC_2<- read.csv("C:/Users/joand/Documents/ShinyGO/ESEC_2_GO_MolecularFunction.csv", header = TRUE, sep = ",")
processos_biologicos_ESEC_2 <- read.csv("C:/Users/joand/Documents/ShinyGO/ESEC_2_GO_BiologicalProcess.csv", header = TRUE, sep = ",")
...
# carregar as tabelas csv
vias_sinalizacao_ECC1 <- read.csv("C:/Users/joand/Documents/ShinyGO/ECC_1_KEGG.csv", header = TRUE, sep = ";")
funcao_molecular_ECC1 <- read.csv("C:/Users/joand/Documents/ShinyGO/ECC_1_GO_MolecularFunction.csv", header = TRUE, sep = ",")
processos_biologicos_ECC1 <- read.csv("C:/Users/joand/Documents/ShinyGO/ECC_1_GO_BiologicalProcess.csv", header = TRUE, sep = ",")
...
# carregar as tabelas csv
funcao_molecular_ECC2 <- read.csv("C:/Users/joand/Documents/ShinyGO/ECC_2_GO_MolecularFunction.csv", header = TRUE, sep = ";")
processos_biologicos_ECC2 <- read.csv("C:/Users/joand/Documents/ShinyGO/ECC_2_GO_BiologicalProcess.csv", header = TRUE, sep = ",")
